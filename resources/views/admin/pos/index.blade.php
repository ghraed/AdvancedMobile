...
@section('content')
    <style>
        .pos-shell{display:grid;grid-template-columns:minmax(0,1.3fr) minmax(380px,.8fr);gap:20px;align-items:start}.pos-sticky{position:sticky;top:20px}.pos-search{font-size:18px;min-height:56px;padding-left:48px}.pos-search-wrap{position:relative}.pos-search-wrap .material-symbols-outlined{position:absolute;left:16px;top:16px;color:var(--admin-muted)}.pos-results{display:grid;grid-template-columns:repeat(auto-fill,minmax(220px,1fr));gap:14px;margin-top:18px}.pos-product{display:grid;grid-template-rows:128px auto;overflow:hidden;border:1px solid var(--admin-border);border-radius:18px;background:var(--admin-surface);text-align:left;padding:0;cursor:pointer;transition:.15s}.pos-product:hover{transform:translateY(-2px);border-color:var(--admin-primary);box-shadow:0 12px 30px rgba(31,29,24,.10)}.pos-product__image{display:grid;place-items:center;background:var(--admin-surface-muted);overflow:hidden}.pos-product__image img{width:100%;height:100%;object-fit:contain}.pos-product__placeholder{font-size:42px;color:var(--admin-border-strong)}.pos-product__body{padding:14px;display:grid;gap:7px}.pos-product__name{font-weight:750}.pos-meta{color:var(--admin-muted);font-size:13px}.pos-product__bottom{display:flex;justify-content:space-between;gap:8px;align-items:center}.pos-price{font-size:18px;font-weight:800}.pos-stock{font-size:12px;color:var(--admin-success);background:var(--admin-success-soft);padding:5px 8px;border-radius:999px}.pos-cart{display:grid;gap:12px;max-height:37vh;overflow:auto;padding-right:3px}.pos-cart-item{border:1px solid var(--admin-border);border-radius:16px;padding:13px;display:grid;gap:9px}.pos-cart-head,.pos-cart-foot,.pos-total-row{display:flex;justify-content:space-between;gap:12px;align-items:center}.pos-cart-name{font-weight:700}.pos-qty{display:flex;align-items:center;gap:8px}.pos-qty button{width:32px;height:32px;border:1px solid var(--admin-border);border-radius:10px;background:var(--admin-surface);cursor:pointer}.pos-remove{border:0;background:transparent;color:var(--admin-danger);cursor:pointer}.pos-summary{border-top:1px solid var(--admin-border);padding-top:16px;display:grid;gap:10px}.pos-total-row--grand{font-size:22px;font-weight:800}.pos-payment-fields{display:grid;grid-template-columns:1fr 1fr;gap:12px}.pos-message{display:none;border-radius:14px;padding:12px;margin-bottom:14px}.pos-message.is-error{display:block;background:var(--admin-danger-soft);color:var(--admin-danger)}.pos-empty{padding:30px 12px;text-align:center;color:var(--admin-muted)}@media(max-width:1100px){.pos-shell{grid-template-columns:1fr}.pos-sticky{position:static}}@media(max-width:620px){.pos-results{grid-template-columns:1fr 1fr}.pos-payment-fields{grid-template-columns:1fr}}
    </style>
