...
class OrderItem extends Model
{
    ...
    protected $fillable = [
        'order_id', 'product_id', 'product_variant_id', 'category_id', 'product_name', 'brand',
        'category_name', 'sku', 'barcode', 'variant_options', 'unit_price_cents', 'unit_cost_cents', 'quantity',
