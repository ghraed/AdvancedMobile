...
class PendingPurchaseSession extends Model
{
    ...
    protected $fillable = ['token_hash', 'user_id', 'product_id', 'product_variant_id', 'option_value_ids', 'installment_plan_id', 'amount_due_today', 'total_amount', 'return_url', 'scheduled_at', 'expires_at'];
